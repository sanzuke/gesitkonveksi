...
class CoreClass
{
  ...
  function updateProgress(){
    ...
    $tanggal = date("Y-m-d", strtotime(mysql_real_escape_string($_POST['tanggal'])));

    $result = mysql_query("UPDATE um_tracking SET progress = '{$progress}', statusdate='{$tanggal}' WHERE id = '${id}' ");
